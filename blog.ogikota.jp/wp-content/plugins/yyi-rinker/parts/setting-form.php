...
<form method="POST" action="">
	...
	<table class="form-table">
		...
		<tr>
			<th>
				<label for="<?php echo self::IS_NO_REAPI_COLUMN ?>_form">商品情報の再取得</label></th>
			<td>
				<?php $is_noapi_checked = !!get_option( $this->option_column_name( self::IS_NO_REAPI_COLUMN ), false );?>
				<div class="radio-box">
					<input id="<?php echo self::IS_NO_REAPI_COLUMN ?>_0_form" type="radio" value="0" name="<?php echo self::IS_NO_REAPI_COLUMN; ?>" <?php if ( !$is_noapi_checked )  { ?>checked="checked" <?php } ?>><label for="<?php echo self::IS_NO_REAPI_COLUMN ?>_0_form">再取得をする</label>
				...
				<div class="radio-box">
					<input id="<?php echo self::IS_NO_REAPI_COLUMN ?>_1_form" type="radio" value="1" name="<?php echo self::IS_NO_REAPI_COLUMN; ?>" <?php if ( $is_noapi_checked )  { ?>checked="checked" <?php } ?>><label for="<?php echo self::IS_NO_REAPI_COLUMN ?>_1_form">再取得をしない</label>
				</div>
...
<?php $is_amazon_detail_checked = $this->is_amazon_detail_url(); ?>
	...
	<h3>もしもアフィリエイト設定</h3>
	<p>IDの取得方法は<a href="https://oyakosodate.com/rinker/getmoshimoid/" target="_blank">もしもIDの取得方法</a>にも記載しています。</p>
	<table class="form-table">
		<tbody>
		<tr>
			<th>
